...
public class Batch4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_batch4);
    ...
    private void setupUIViews(){
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                firebaseFirestore.collection("Schedule").document("Batch4")
                        .set(SS_Map).addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Batch4.this,"Schedule For Batch " +tBatch+ " Added",Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        String error = e.getMessage();
                        Toast.makeText(Batch4.this,"Error: " +error,Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                firebaseFirestore.collection("Schedule").document("Batch4")
                    ...
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Batch4.this,"Schedule For Batch " +tBatch+ " Updated",Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Batch4.this, "Schedule will be deleted.", Toast.LENGTH_SHORT).show();
            }
        });
