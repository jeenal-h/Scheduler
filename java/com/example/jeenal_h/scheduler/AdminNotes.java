...
public class AdminNotes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admin_notedisplay);

        coordinatorLayout = (CoordinatorLayout) findViewById(R.id.coordinatorLayout);
        mydb = new AdminNDb(this);
        ...
        String[] fieldNames = new String[]{AdminNDb.name, AdminNDb._id, AdminNDb.dates, AdminNDb.remark};
        int[] display = new int[]{R.id.txtnamerow, R.id.txtidrow,
                R.id.txtdate, R.id.txtremark};
        adapter = new SimpleCursorAdapter(this, R.layout.admin_listtemplate, c, fieldNames,
                display, 0);
        snackbar = Snackbar
        ...
        mylist.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                {
                    PopupMenu popup = new PopupMenu(AdminNotes.this, mylist);
                    popup.setOnMenuItemClickListener((PopupMenu.OnMenuItemClickListener) AdminNotes.this);
