...
public class Batch3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_batch3);
    ...
    private void setupUIViews(){
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                firebaseFirestore.collection("Schedule").document("Batch3")
                        .set(SS_Map).addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Batch3.this,"Schedule For Batch " +tBatch+ " Added",Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        String error = e.getMessage();
                        Toast.makeText(Batch3.this,"Error: " +error,Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                firebaseFirestore.collection("Schedule").document("Batch3")
                    ...
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Batch3.this,"Schedule For Batch " +tBatch+ " Updated",Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Batch3.this, "Schedule will be deleted.", Toast.LENGTH_SHORT).show();
            }
        });
