...
public class AdminDisplayNote extends AppCompatActivity {
    private AdminNDb mydb;
    EditText name;
    EditText content;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admin_viewnotepad);
        ...
        if (extras != null) {
            ...
            if (Value > 0) {
                ...
                id_To_Update = Value;
                rs.moveToFirst();
                String nam = rs.getString(rs.getColumnIndex(AdminNDb.name));
                String contents = rs.getString(rs.getColumnIndex(AdminNDb.remark));
                if (!rs.isClosed()) {
                    rs.close();
                }
                        ...
                        .setPositiveButton("YES",
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog,
                                        ...
                                        Toast.makeText(AdminDisplayNote.this, "Deleted Successfully",Toast.LENGTH_SHORT).show();
