            ...
            public void onClick(View v) {
                ...
                firebaseFirestore.collection("Users").document("Details")
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(AddTeacher.this,"Teacher Details Added",Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        String error = e.getMessage();
                        Toast.makeText(AddTeacher.this,"Error: " +error,Toast.LENGTH_SHORT).show();
                    }
                });
                ...
                if(T_name.isEmpty() || T_designation.isEmpty() || T_mobile.isEmpty() || T_email.isEmpty() || T_type.isEmpty()){
                    Toast.makeText(AddTeacher.this,"Please enter all the details",Toast.LENGTH_SHORT).show();
                }
                else if(T_password.length()<8){
                    Toast.makeText(AddTeacher.this,"Password should be greater than or equal to 8 characters",Toast.LENGTH_SHORT).show();
                }
                else if(T_mobile.length()<10){
                    Toast.makeText(AddTeacher.this,"Mobile number should be of minimum 10 digits",Toast.LENGTH_SHORT).show();
                }
                else {
                            ...
                            .addOnCompleteListener(AddTeacher.this, new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if(task.isSuccessful()){
                                        Toast.makeText(AddTeacher.this,"Teacher Registered Successfully", Toast.LENGTH_SHORT).show();
                                        onBackPressed();
                                    }
                                    else{
                                        Toast.makeText(AddTeacher.this,"Error Registering Teacher", Toast.LENGTH_SHORT).show();
                                        onBackPressed();
                                    }
                                }
                            });
