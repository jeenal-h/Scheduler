...
public class TeacherDisplayNote extends AppCompatActivity {
    private TeacherNDb mydb;
    EditText name;
    EditText content;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.teacher_viewnotepad);
        ...
        if (extras != null) {
            ...
            if (Value > 0) {
                ...
                id_To_Update = Value;
                rs.moveToFirst();
                String nam = rs.getString(rs.getColumnIndex(TeacherNDb.name));
                String contents = rs.getString(rs.getColumnIndex(TeacherNDb.remark));
                if (!rs.isClosed()) {
                    rs.close();
                }
                        ...
                        .setPositiveButton("YES",
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog,
                                        ...
                                        Toast.makeText(TeacherDisplayNote.this, "Deleted Successfully",Toast.LENGTH_SHORT).show();
