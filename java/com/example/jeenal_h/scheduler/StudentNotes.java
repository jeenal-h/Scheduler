...
public class StudentNotes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.student_notedisplay);
        ...
        String[] fieldNames = new String[]{StudentNDb.name, StudentNDb._id, StudentNDb.dates, StudentNDb.remark};
        int[] display = new int[]{R.id.txtnamerow, R.id.txtidrow,
                R.id.txtdate, R.id.txtremark};
        adapter = new SimpleCursorAdapter(this, R.layout.student_listtemplate, c, fieldNames,
                display, 0);
        snackbar = Snackbar
        ...
        mylist.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                {
                    PopupMenu popup = new PopupMenu(StudentNotes.this, mylist);
                    popup.setOnMenuItemClickListener((PopupMenu.OnMenuItemClickListener) StudentNotes.this);
